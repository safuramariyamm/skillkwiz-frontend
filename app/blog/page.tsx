...
export default function BlogPage() {
  ...
  const indicatorClasses = (index: number) =>
    `h-1.5 rounded-full transition-all duration-300 ${hoveredIndex === index ? "w-64 bg-[#00418d]" : "w-24 bg-[#c3dfff]"
    }`;

  // All blog posts data with full content
  const allBlogPosts = [
    {
      id: 1,
    ...
    },
    {
      ...
      content: `
        ...
        <p>Artificial intelligence is revolutionizing how we approach education. Machine learning algorithms analyze learning patterns, preferences, and performance data to create personalized learning paths for each student.</p>
        ...
        <p>Access to technology and reliable internet remains a barrier. Solutions include offline-first applications and low-bandwidth learning options.</p>

        <h3>Quality Assurance</h3>
        <p>With the proliferation of online content, ensuring quality becomes challenging. Accreditation systems and peer review processes help maintain educational standards.</p>

        <h3>Motivation and Engagement</h3>
        <p>Online learners often struggle with isolation and lack of accountability. Gamification, social features, and structured learning paths address these challenges.</p>

        <h2>The Road Ahead</h2>
        <p>The future of online learning is bright and full of possibilities. As technology continues to advance, we can expect even more immersive, personalized, and effective learning experiences. The key to success lies in thoughtfully combining technological innovation with pedagogical best practices and human-centered design.</p>
      `,
  ...
  const secondaryPosts = allBlogPosts.slice(3, 5);
  const knowledgeArticles = allBlogPosts.slice(5);
  return (
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {featuredPosts.map((post, index) => (
                <article
                  key={post.id}
                  className="group cursor-pointer bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:-translate-y-1"
