    ...
    <div className="text-white">
      ...
      {view === "login" && (
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <a href="${process.env.NEXT_PUBLIC_API_URL || "http://localhost:5000/api"}/auth/google" className="w-full py-3 rounded border border-gray-500 text-white hover:bg-white/10 font-medium flex items-center justify-center gap-2 transition-all">
